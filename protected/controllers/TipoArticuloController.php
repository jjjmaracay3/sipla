...
class TipoArticuloController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['TipoArticulo'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->nu_tipo_articulo));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('TipoArticulo');
	 ...
	 * @param TipoArticulo $model the model to be validated
	 */
