...
class ArticuloTecnologico extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nu_tipo_articulo, al_nombre_articulo, al_descripcion_articulo, al_marca_articulo, al_modelo_articulo, de_precio_unitario, al_color_articulo, al_unidad_medida', 'required'),
			array('nu_tipo_articulo', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('nu_articulo, nu_tipo_articulo, al_nombre_articulo, al_descripcion_articulo, al_marca_articulo, al_modelo_articulo, de_precio_unitario, al_color_articulo, al_unidad_medida', 'safe', 'on'=>'search'),
		);
	}
